        ...
        const words = [
            'dream', 'light', 'time', 'space', 'future', 'mind', 'truth', 'fire', 'stone', 'river', 'wind', 'shadow', 'echo', 'path', 'voice', 'heart', 'storm', 'memory', 'wave', 'field', 'Jacobins', 'typobold',
            'sky', 'seed', 'thought', 'ocean', 'spark', 'dreamer', 'moment', 'vision', 'silence', 'forest', 'sound', 'cloud', 'mountain', 'dust', 'feather', 'flame', 'story', 'dreams', 'hope', 'tactile', 'Jacobins', 
            'soul', 'energy', 'mirror', 'night', 'day', 'world', 'circle', 'magic', 'shape', 'flow', 'Jacobins'
        ];
        ...
        const fontVariants = ['Jacobins-Regular', 'Jacobins-SemiBold', 'Jacobins-ExtraBold', 'Jacobins-Medium', 'Jacobins-Bold'];
